...
- 通过api反射可以获取的信息，使用这些信息可以重新生成对应的泛型类
  ...
  ![4种泛型使用凡是](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//Type%E6%8E%A5%E5%8F%A3%E5%8F%8A%E5%85%B6%E5%AD%90%E7%B1%BB%E6%88%96%E6%8E%A5%E5%8F%A3.png)
...
![集合框架接口总览](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//%E9%9B%86%E5%90%88%E6%A1%86%E6%9E%B6%E7%9A%84%E6%8E%A5%E5%8F%A3%E7%A4%BA%E6%84%8F%E5%9B%BE.png)

![集合框架类总览](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//%E9%9B%86%E5%90%88%E6%A1%86%E6%9E%B6%E4%B8%AD%E7%9A%84%E7%B1%BB.png)
...
- 使用link data双重关联的方式实现，使用链表删除或者新增其中一个元素只会影响该元素关联的两个元素
  ...
  ![链表存储的双重关联](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//%E9%93%BE%E8%A1%A8%E5%AD%98%E5%82%A8%E6%95%B0%E6%8D%AE%E4%B9%8B%E9%97%B4%E7%9A%84%E5%85%B3%E8%81%94.png)

  ![LinkedList 添加元素](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//%E4%BD%BF%E7%94%A8link%E8%BF%AD%E4%BB%A3%E5%99%A8%E6%B7%BB%E5%8A%A0%E5%85%83%E7%B4%A0.png)

  ![链表删除元素](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//%E4%BD%BF%E7%94%A8%E9%93%BE%E8%A1%A8%E5%88%A0%E9%99%A4.png)
...
- 可以获取使用ListIterator和迭代器使用
  ...
  ![迭代器运行方式](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//java%E4%B8%ADiterator%E7%9A%84%E8%BF%90%E8%A1%8C%E6%96%B9%E5%BC%8F.png)
...
- 是将元素压缩放入一个动态分配的数组之中
  ...
  ![数组中删除元素的方法](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//%E6%95%B0%E7%BB%84%E4%B8%AD%E5%88%A0%E9%99%A4%E5%85%83%E7%B4%A0%E7%9A%84%E6%96%B9%E5%BC%8F.png)
...
- hashtable 存储数据结构的基本了解
  ...
  ![hash table结构示意图](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//hash_table%E7%A4%BA%E6%84%8F%E5%9B%BE.png)
...
- 队列是在尾部添加元素，头部删除元素的数据结构
  ...
  ![队列实现示意图](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//%E9%98%9F%E5%88%97%E7%9A%84%E5%AE%9E%E7%8E%B0%E5%BD%A2%E5%BC%8F.png)
...
![collection的具体实现](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//collection%E5%85%B7%E4%BD%93%E7%B1%BB%E6%8F%8F%E8%BF%B0.png)
...
- linked hash sets and maps
  ...
  ![linkedhashMap的双重链表](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//linkhashMap%E7%9A%84%E5%8F%8C%E9%87%8D%E9%93%BE%E8%A1%A8%E7%BB%93%E6%9E%84.png)
...
- 已经被整合到集合框架里面了，了解不要使用
  ...
  ![旧有集合和集合框架之间的整合](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//java%E9%9B%86%E5%90%88%E6%A1%86%E6%9E%B6%E7%BB%A7%E6%89%BF%E7%9A%84%E5%B0%B1%E6%9C%89%E9%9B%86%E5%90%88.png)
...
- 如何获取正确的属性设置
  ...
  ![jframe的继承体系](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//JFrame%E7%9A%84%E7%BB%A7%E6%89%BF%E4%BD%93%E7%B3%BB.png)
...
- frame 分为四层root pane, layered pane, and glass pane，我们在content pane中放置组件
  ...
  ![frame结构示意图](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//JFrame的结构.png)
...
- 图像都是继承Shape 类由，draw() 方法调用
  ...
  ![shape之间的继承关系](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//shape%E4%B9%8B%E9%97%B4%E7%9A%84%E7%BB%A7%E6%89%BF%E5%85%B3%E7%B3%BB.png)

- 图形的计算结果使用单精度浮点数，在取整的情况下会产生一像素的误差。

  但是java默认是双精度，需要进行转换new Rectangle2D.Double 这种方法提供两种精度坐标，注意即使是单精度坐标其返回结果也是双精度，惊不惊喜呃。

  ![shape的双精度实现方式](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//%E5%9B%BE%E5%BD%A2%E5%8F%8C%E7%B2%BE%E5%BA%A6%E5%9D%90%E6%A0%87%E7%9A%84%E5%AE%9E%E7%8E%B0%E6%96%B9%E5%BC%8F.png)
...
- 文字在frame居中显示
  ...
  1.  高度，矩形的高度由三部分组成
     ...
     ![字体格式示意图](https://raw.githubusercontent.com/dsapt1/javacore_reader_note/master/已使用//font%E6%A0%BC%E5%BC%8F.png)
